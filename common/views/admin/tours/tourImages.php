        ...
        <fieldset>
            <div class="control-group">
                ...
                <div class="controls">
                    ...
                    <input type="submit" name="createTour" value="Add Image" class="btn btn-primary"/>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row">
            <?php foreach($images as $image) { ?>
                <div class="span3 ">
                    <a href="index.php?c=tours&m=deleteImage&id=<?php echo $image->getId(); ?>" class="btn btn-mini btn-danger ">Delete</a>
